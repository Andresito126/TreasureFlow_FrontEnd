...
class RegisterCitizenProvider extends ChangeNotifier {
  ...
  RegisterCitizenStatus _status = RegisterCitizenStatus.idle;
  String? _errorMessage;
  File? _selectedImage;

  RegisterCitizenStatus get status => _status;
  ...
  Future<void> signUp({
    ...
    if (_selectedImage == null) {
      ...
      _status = RegisterCitizenStatus.error;
      notifyListeners();
      return;
    }

    _status = RegisterCitizenStatus.loading;
    _errorMessage = null;
    notifyListeners();
    ...
    try {
      ...
      _status = RegisterCitizenStatus.success;
