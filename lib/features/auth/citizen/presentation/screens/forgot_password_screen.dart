...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void _onProviderChanged() {
    ...
    if (_provider.requestStatus == RequestCodeStatus.sent) {
      AppToast.show(
        context,
        'Te enviamos un código por SMS',
        type: ToastType.success,
      );
    } else if (_provider.requestStatus == RequestCodeStatus.error) {
      AppToast.show(
        context,
    ...
    if (_provider.resetStatus == ResetPasswordStatus.success && !_navigated) {
      _navigated = true;
      AppToast.show(
        context,
      ...
      context.go('/login');
      return;
    } else if (_provider.resetStatus == ResetPasswordStatus.error) {
      AppToast.show(
        context,
